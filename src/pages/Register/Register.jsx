...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white p-4 relative overflow-hidden">
      {/* Background Graphics */}
      <motion.div
        className="absolute top-0 left-0 w-64 h-64 bg-purple-300 opacity-30 rounded-full"
        animate={{ scale: [1, 1.5, 1] }}
        transition={{ repeat: Infinity, duration: 5 }}
      ></motion.div>

      <motion.div
        className="absolute bottom-0 right-0 w-80 h-80 bg-blue-300 opacity-30 rounded-full"
        animate={{ scale: [1, 1.5, 1] }}
